...
class NetWorkPerformance extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
      let data = nextProps.netWorkPerformance;
      this.state.values[0] = data[18] + data[21];
      this.state.values[1] = data[2];

      this.state.values[2] = data[16] + data[17];
      this.state.values[3] = data[6];

      this.state.values[4] = data[1];
      this.state.values[5] = data[7] + data[26];

      this.state.values[6] = data[10];
      this.state.values[7] = data[0];

      this.state.values[8] = data[8];
      this.state.values[9] = data[25] + data[4];

      this.state.values[10] = data[27];
      this.state.values[11] = data[5];

      this.state.values[12] = data[19] + data[22] + data[23] + data[24];
      this.state.values[13] = data[3];

      this.state.values[14] = data[12] + data[14] + data[15];
    }
