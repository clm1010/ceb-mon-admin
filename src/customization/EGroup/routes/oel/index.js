...
export default connect(({
 oel, oelEventFilter, oelToolset, oelDataSouseset, eventviews, loading,
}) => ({
 oel, oelToolset, oelEventFilter, oelDataSouseset, eventviews, loading,
}))(oel)
