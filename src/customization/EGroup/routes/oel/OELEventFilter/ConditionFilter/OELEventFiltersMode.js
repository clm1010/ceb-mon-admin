...
const oelmodal = ({
 ...
 getFieldDecorator, validateFields, getFieldsValue, resetFields,
  ...
  const onOk = () => {
	  ...
	  let mofilterval = {}
	  let fields = ['name', 'description', 'isGlobal', 'basicLogicOp', 'filterMode', 'value_1000']
	  let filterIndex = [0]
	  ...
	  filterIndex.forEach((num) => {
		...
		if (valObj.filterMode === 'OTHER') {
			mofilterval.filterItems = [{ field: '', op: '', value: valObj.value_1000 }]
		} else {
