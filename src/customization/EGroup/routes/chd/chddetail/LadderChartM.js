...
//	});
	const option = {
		...
		legend: {
			data: ['最小端口输入流量', '最大端口输入流量', '最小端口输出流量', '最大端口输出流量', '端口输入流量平均值', '端口输出流量平均值'],
			textStyle: {
				fontSize: 9,
			},
			itemGap: 5,
			itemHeight: 15,
			selected: {
 最小端口输入流量: false, 最大端口输入流量: false, 最小端口输出流量: false, 最大端口输出流量: false, 端口输入流量平均值: true, 端口输出流量平均值: true,
},
		},
		dataZoom: [{
				xAxisIndex: 0,
	...
	//'最小端口输入流量', '最大端口输入流量', '最小端口输出流量', '最大端口输出流量', '端口输入流量平均值', '端口输出流量平均值'
	const onDownload = () => {
		Modal.confirm({
			title: '确认需要导出图表数据吗？',
			onOk () {
