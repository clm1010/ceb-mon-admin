 ...
 const onCancel = () => {
  ...
  <Form layout="horizontal">
    ...
    <Row>
      ...
      <Col span={7} className={mystyle.rowSpacing}><Input value={new Date(indicatorsItem.createdTime).toLocaleDateString()} disabled /></Col>
      ...
      <Col span={7} className={mystyle.rowSpacing}><Input value={new Date(indicatorsItem.updatedTime).toLocaleDateString()} disabled /></Col>
    </Row>
