...
const ruleInstance = ({
	...
	onIssueForbid,disItem, filterMode,fields, criteria,checkedTerrList, issueFlag,moCritera} = ruleInstance	//这里把入参tool做了拆分，后面代码可以直接调用拆分的变量
	   /*
		   获取树节点
	   */
   ...
   //		columns: RuleColumns,
	 ...
	 const dataModalStdInfoProps = {
		   ...
		   treeNodes: ((stdIndicatorGroup && stdIndicatorGroup.treeDatas && stdIndicatorGroup.treeDatas.length > 0) ? stdIndicatorGroup.treeDatas : []),
