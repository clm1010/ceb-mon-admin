...
import ButtonZone from '../registerServices/ButtonZone'
import queryString from "query-string"
import FilterSchema from './FilterSchema'
import List from '../registerServices/List'
import Modal from './Modal'
import { routerRedux } from 'dva/router'
import ImportResultModal from '../../../../routes/objectMO/ImportByExcel/ImportResultModal'
const perRegisServer = ({
    ...
    const { list, q, pagination, choosedRows, modalVisible, modalType, currentItem, tempListMeta, tempListChecks, moImportResultVisible,
        moImportResultType, moImportResultdataSource, regColumns, batchDelete, serviceArea,  projectsData,clusterData,namespaceData,serverData,podData,portObj
     } = registerServices
    ...
    const modalProps = {						//这里定义的是弹出窗口要绑定的数据源
        ...
        tempListMeta1:tempListMeta,
        tempListChecks1:tempListChecks,
        user,
        serviceArea,
        projectsData,
        clusterData,
...
export default connect(({ registerServices, loading }) => ({ registerServices, loading }))(perRegisServer)