...
const oelhint = ({
 location, dispatch, oelhint, oelEventFilter, loading, oelToolset, oelDataSouseset, eventviews,
}) => {
	const {
    ...
    isPackedAlarms, treeNodes, visibleSubAlarms, subAlarms, subPagination, subSelectedRows, processEventVisibleSub, workOrderVisibleSub, selectedKeys, treeCollapse,visibleSearchFilter ,appNameList, fetchingApp,appNameNum,Service_Impact_Num,HotPotNum,callOutList,callUsers,treeTip
} = oelhint
  ...
  const listProps = { //这里定义的是查询页面要绑定的数据源
    dispatch,
    dataSource: list,
    loading: loading.effects['oelhint/query'],
    pagination,
    location,
    tagFilters,
    currentSelected,
...
export default connect(({
 oelhint, oelEventFilter, oelToolset, oelDataSouseset, eventviews, loading,
}) => ({
  oelhint, oelToolset, oelEventFilter, oelDataSouseset, eventviews, loading,
}))(oelhint)
