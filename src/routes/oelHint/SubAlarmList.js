...
import { Form, Table, Row, Col, Icon, message, Badge, Modal } from 'antd'
import { ContextMenu, MenuItem, ContextMenuTrigger, SubMenu } from 'react-contextmenu'
import './List.css'
import { ozr } from '../../utils/clientSetting'
//import DetailModal from './SubAlarmDetailModal'
...
function subalarmlist({
	dispatch, loading, dataSource, pagination, location, oelColumns, oelDatasource, oelFilter, oelViewer, toolList, selectedRows, user, visibleSubAlarms,
	modalDetailProps, modalProcessEventProps, modalWorkOrderProps
}) {
	const modelOpts = modalDetailProps
	//循环选中的行 抽取一个简单的OZ_AlarmID数组做判断
	let selectedRowKeys = selectedRows.map(v => v.OZ_AlarmID)
	let roleArr = [], givenForceCloseArr = []
				...
				if (dateFields.indexOf(col.dataIndex) >= 0) {
					col.render = (text, record) => {
						if (record[col.dataIndex] != undefined) {
							return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{new Date(record[col.dataIndex] * 1000).format('yyyy-MM-dd hh:mm:ss')}</div></ContextMenuTrigger>
						}
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{record[col.dataIndex]}</div></ContextMenuTrigger>
					}
				} else if (col.dataIndex === 'N_SummaryCN') {
					col.render = (text, record) => {
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis"><span style={{ float: 'left', marginLeft: 10 }}>{record[col.dataIndex]}</span></div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						if (record.OZ_IsRoot === 1) {
							oz_knowledge_flag = <Icon type="thunderbolt" theme="filled" />
						} else if (record.OZ_IsRoot === 4) {
							oz_knowledge_flag = <Icon type="thunderbolt" />
						}
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}>
							<div title={record[col.dataIndex]} className="oel-ellipsis" style={{ background: backgroundColor, color, height: '100%' }}>{oz_knowledge_flag} {n_CustomerSeverity}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className ='oel-ellipsis'>{type}</div></ContextMenuTrigger>
			    	}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{Acknowledged}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{ExpireTime}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{Flash}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_EventStatus}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_MaintainStatus}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_ManageByCenter}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_RecoverType}</div></ContextMenuTrigger>
					}
				} else if (col.dataIndex === 'N_CustomerSeverity') {
					let Severity = '未知'
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{Severity}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{SuppressEscl}</div></ContextMenuTrigger>
					}
				} else if (col.dataIndex === 'Type') {
					let Type = '未知'
					col.render = (text, record) => {
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_ZProcessState}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_AckMode}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_Close}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_NPassHis}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_AckOverTime}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_CloseOverTime}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_TicketStatus}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{N_Processed}</div></ContextMenuTrigger>
					}
					...
					col.render = (text, record) => {
						...
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{OZ_MaintainProcess}</div></ContextMenuTrigger>
					}
				} else {
					col.render = (text, record) => {
						return <ContextMenuTrigger collect={collect} upperName={col.key} name={col.dataIndex} id="subalarm" OZ_AlarmID={record.OZ_AlarmID} record={record} holdToDisplay={1000}><div title={record[col.dataIndex]} className="oel-ellipsis">{record[col.dataIndex]}</div></ContextMenuTrigger>
	...
	const onOk = () => {															//弹出窗口中点击取消按钮触发的函数
		dispatch({
			type: 'oelhint/updateState',													//抛一个事件给监听这个type的监听器
			payload: {
				visibleSubAlarms: false,
			},
		})
	}

	const onCancel = () => {		
		pagination.current = 1													//弹出窗口中点击取消按钮触发的函数
		dispatch({
			type: 'oelhint/updateState',													//抛一个事件给监听这个type的监听器
			payload: {
				visibleSubAlarms: false,
				subPagination: pagination
			},
		})
	}
	...
	return (
		<Modal {...modalOpts} width={widths - 50} bodyStyle={{ height: 600 }}>
			<div>
				<Row gutter={24}>
...
export default Form.create()(subalarmlist)
