	...
	return (
		<Row gutter={24} style={{ marginTop: 8, marginBottom: 8 }} >
			<Col lg={24} md={24} sm={24} xs={24}>
				...
				<Button style={{ marginLeft: 8 }} size="default" type="ghost" onClick={onIssue.bind(this, 'normal')} disabled={onIssueForbid}>下发</Button>
				...
				{/* <Button style={{ marginLeft: 8 }} size="default" type="ghost" onClick={onIssue.bind(this, 'APM')} disabled={onIssueForbid}>APM下发</Button> */}
				{myCompanyName === 'EGroup' ? <Button style={{ marginLeft: 8 }} size="default" type="ghost" onClick={onIssue.bind(this, 'APM')} disabled={onIssueForbid}>APM下发</Button> : null}
			</Col>
		</Row>
	)
}
