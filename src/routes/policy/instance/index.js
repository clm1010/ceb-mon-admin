...
const policyInstance = ({
 policyInstanceGroup, location, dispatch, stdIndicatorGroup, policyInstance, loading, objects,
	...
	const {
 policyTemplet, indicatorsItem, stdInfoVal, obInfoVal, stdList, obList, timeList, kpiVisible, objectVisible, list, stdgroupUUID, obgroupUUID, pagination, pagination1, pagination2, pagination3, currentItem, modalVisible, modalType, checkStatus, isClose, batchDelete, choosedRows,
filterSchema, tabstate, typeValue, see, expand,filter,selectIndex,resetCalInput,modaType,advancedItem,
