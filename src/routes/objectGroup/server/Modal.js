...
const modal = ({
	...
	const onOk = () => {
		validateFieldsAndScroll((errors) => {
			...
			dispatch({
				type: 'server/setState',				//@@@//抛一个事件给监听这个type的监听器
				payload: {
					modalVisible: false,
					FScloud:false,
				},
	...
	//end
	return (
		<Modal {...modalOpts} width={1050} key="serverModal">
			<Form layout="horizontal">
				...
				<span style={{width: '50%',float: 'left'}}>
					<FormItem label="二级安全域" key="secondSecArea"  hasFeedback {...formItemLayout}>
						...
						})(<Select allowClear>{secondSecArea}</Select>)}
					</FormItem>
				</span>
				*/}
				<span style={{ width: '33%', float: 'left' }}>
