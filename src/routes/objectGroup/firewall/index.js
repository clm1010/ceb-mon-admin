...
//@@@
const firewall = ({
 app, location, dispatch, firewall, policyList, interfaceList, interfacer, moSingleSelect, loading, appSelect,
}) => {
	const {
		q,
		list,
		...
		snmpVerflag,
		optionSelectAppName,
	} = firewall					//@@@//这里把入参做了拆分，后面代码可以直接调用拆分的变量
...
export default connect(({
 app, firewall, policyList, interfacer, interfaceList, moSingleSelect, appSelect, loading,
}) => ({
 app, firewall, policyList, interfacer, interfaceList, moSingleSelect, appSelect, loading,
}))(firewall)	//@@@
