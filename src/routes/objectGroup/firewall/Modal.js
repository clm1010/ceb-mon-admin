...
import { Form, Input, Modal, Button, Select, DatePicker, Icon, Alert, Tooltip, message, Divider, Tabs } from 'antd'
...
const modal = ({
	...
	const onCancel = () => { //弹出窗口中点击取消按钮触发的函数
		resetFields()
		dispatch({
			type: 'firewall/setState',				//@@@//抛一个事件给监听这个type的监听器
			payload: {
				modalVisible: false,
				FScloud:false,
				snmpVerflag:true,
