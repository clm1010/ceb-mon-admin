...
//@@@
const database = ({
 location, dispatch, database, appSelect, objectGroup, loading, app, policyList
}) => {
	const {
		q,
		list,
		...
		FScloud,
		optionSelectAppName,
	} = database					//@@@//这里把入参做了拆分，后面代码可以直接调用拆分的变量
...
export default connect(({
 database, appSelect, app, loading, policyList
}) => ({
 database, appSelect, app, loading, policyList
}))(database) //@@@
