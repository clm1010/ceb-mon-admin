...
function list({
	dispatch, loading, dataSource, pagination, batchDelete, selectedRows, controllerNumber, q, user
}) {
	...
	columns.push({
		...
		render: (text, record) => {
			return (<div style={{ display: 'flex', justifyContent:'space-around' }}>
				<Button s size="small" type="ghost" shape="circle" icon="edit" onClick={() => onEdit(record)} />
