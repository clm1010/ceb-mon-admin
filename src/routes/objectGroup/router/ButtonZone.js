...
import { Modal, Row, Col, Icon, Button, Upload, message, Divider, Descriptions } from 'antd'
...
function buttonZone({
	dispatch, batchDelete, selectedRows, user, moImportFileList, showUploadList, moImportResultVisible, moImportResultdataSource, moImportResultType,
}) {
			...
			<Col lg={24} md={24} sm={24} xs={24}>
				{
					disPower ?
						<>
							...
							<Button style={{ marginLeft: 8 }} size="default" type="ghost" onClick={onDelete} disabled={!batchDelete} icon="delete" />
