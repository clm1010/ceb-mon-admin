...
import { Row, Col, Icon, Button, Upload, message, Modal } from 'antd'
...
function buttonZone({
	...
	const onRulePreview = () => {
		...
		window.open(`/rulespreview?ids=${ids}&branches=${branches}&firstClass=OS`, '批量下发预览', '', 'false')
	}
	...
	return (
		<Row gutter={24} style={{ marginTop: 8, marginBottom: 8 }} >
			<Col lg={24} md={24} sm={24} xs={24}>
				...
				<Button style={{ marginLeft: 8 }} size="default" type="ghost" onClick={onDelete} disabled={!batchDelete}>批量删除</Button>
