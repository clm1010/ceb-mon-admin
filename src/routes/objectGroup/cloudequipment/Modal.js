...
const modal = ({
	...
	const onOk = () => {
		validateFieldsAndScroll((errors) => {
			...
			data.cloudDeviceType = 'cloudDeviceType'
			data.tye = 'cloudDeviceType'
	...
	return (
		<Modal {...modalOpts} width={1050}>
			<Form layout="horizontal">
				...
				<span style={{ width: '33%', float: 'left' }}>
					<FormItem label="类别" key="cloudDeviceType" hasFeedback {...formItemLayout}>
						{getFieldDecorator('cloudDeviceType', {
							initialValue: '云设备',
							rules: [
								{
									required: true,
