...
const cloudequipment = ({
 location, loading, cloudequipment, dispatch, app, appSelect,
}) => {
	const {
		q,
		batchDelete,
	...
	const listProps = {
		dispatch,
		loading: loading.effects['cloudequipment/query'],
		dataSource,
		pagination,
		batchDelete,
		selectedRows,
	...
	const importResultModalProps = {
  		...
  		queryPath: 'cloudequipment/setState',
  	}
...
export default connect(({
 cloudequipment, app, appSelect, loading,
}) => ({
 cloudequipment, app, appSelect, loading,
}))(cloudequipment)
