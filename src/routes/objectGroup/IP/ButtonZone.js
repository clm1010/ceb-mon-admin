...
const buttonZone = ({
	dispatch, loading, batchDelete, selectedRows, showUploadList, moImportResultType, user, moImportFileList,
}) => {
			...
			<Col lg={24} md={24} sm={24} xs={24}>
				{
					disPower ?
						<>
							...
							<Button style={{ marginLeft: 8 }} size="default" type="ghost" disabled={!batchDelete} onClick={onDelete}>删除</Button>
