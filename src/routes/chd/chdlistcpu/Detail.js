...
import { Row, Col, Tooltip, Select, Icon, Table, Input, Spin, Badge, DatePicker } from 'antd'
 ...
 width: '100%', height: '342px', marginBottom: '6px', backgroundColor: '#FFFFFF',
      ...
      >
        <div style={{ fontSize: '16px' }}>
          ...
          <span style={{ float: 'right', fontSize: '12px' }} key={keys}>
								&nbsp;&nbsp;粒度 :&nbsp;
            <Select defaultValue={memGran} style={{ width: 80 }} size="small" onChange={handleMemGranChange}>
              {/*<Select.Option value="year">年</Select.Option>*/}
              <Select.Option value="month">月</Select.Option>
              <Select.Option value="day">日</Select.Option>
              <Select.Option value="hour">小时</Select.Option>
